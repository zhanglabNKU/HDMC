...
from adversarial_multi import training, testing
...
batch_split = [9, 21]  # cluster numbers of the first and first two batches
log_interval = 1
# CUDA
...
if __name__ == '__main__':
    data_folder = 'multi/'
    dataset_file_list = ['muraro_seurat.csv', 'baron_seurat.csv', 'seger_seurat.csv']
    cluster_similarity_file = data_folder + 'multi_metaneighbor.csv'
    ...
    dataset_dict = {1: 'Muraro', 2: 'Baron', 3: 'Seger'}
