...
low_thr = 0.6  # lower threshold in the paper
...
batch_split = 3  # number of clusters in the first batch
log_interval = 1
# CUDA
...
if __name__ == '__main__':
    data_folder = 'simulate/'
    dataset_file_list = ['batch1_removed_type1_seurat.csv', 'batch2_removed_type4_seurat.csv']
    cluster_similarity_file = data_folder + 'simulate_metaneighbor.csv'
    ...
    # plot results
    cell_type_dict = {1: 'type1', 2: 'type2', 3: 'type3', 4: 'type4'}
    dataset_dict = {1: 'simulate_batch1', 2: 'simulate_batch2'}
