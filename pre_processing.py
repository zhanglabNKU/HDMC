...
def read_cluster_similarity(filename, high_thr, low_thr):
    ...
    Args:
        ...
        high_thr: threshold for identifying similar cluster pairs
        low_thr: threshold for identifying noisy cluster pairs
    Returns:
    ...
    # find the dissimilar clusters from different batches
    dissimilar = []
    for i in range(num_cls):
        for j in range(num_cls):
            if low_thr < cluster_matrix[i][j] < high_thr:
    ...
    cluster_matrix[cluster_matrix < high_thr] = 0
